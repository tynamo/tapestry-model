        ...
        PersistenceService, ApplicationContextAware
{
    ...
    public List getAllInstances(Class type)
    {
        ...
        return getHibernateTemplate().loadAll(Utils.checkForCGLIB(type));
    }
    ...
    public List getInstances(final Object example)
    {
        return (List) getHibernateTemplate().execute(new HibernateCallback()
        {
            ...
            public Object doInHibernate(Session session) throws HibernateException, SQLException
            {
                ...
                Iterator propertyDescriptorIterator = descriptorService.getClassDescriptor(example.getClass()).getPropertyDescriptors().iterator();
                        ...
                        try
                        {
                            ...
                            if (value != null)
                            {
                                ...
                                } else if (propertyDescriptor.isObjectReference())
                                {
                                    ...
                                    Object identifierValue = Ognl.getValue(descriptorService.getClassDescriptor(value.getClass()).getIdentifierDescriptor().getName(), value);
                                ...
                                { //one-to-many or many-to-many
                                    ...
                                    if (associatedItems != null && associatedItems.size() > 0)
                                    {
                                        ...
                                        String identifierName = descriptorService.getClassDescriptor(item.getClass()).getIdentifierDescriptor().getName();
                                        ...
                                        searchCriteria.createCriteria(propertyName).add(Restrictions.in(identifierName, values));
