...
public class Hibernate4SessionManagerImpl implements HibernateSessionManager, ThreadCleanupListener
{
	private final Session session;

	private Transaction transaction;

	public Hibernate4SessionManagerImpl(HibernateSessionSource source)
	{
