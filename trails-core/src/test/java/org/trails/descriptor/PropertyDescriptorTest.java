...
public class PropertyDescriptorTest extends TestCase {
	public void testIsNumeric() throws Exception {
		...
		IPropertyDescriptor propertyDescriptor = new TrailsPropertyDescriptor(
				Foo.class, Double.class);
	...
	public void testDisplayName() throws Exception {
		...
		assertEquals("display name", "Multi Word Property", propertyDescriptor
				.getDisplayName());
	}

	public void testIsDate() throws Exception {
		java.beans.PropertyDescriptor realDescriptor = new java.beans.PropertyDescriptor(
				"date", Foo.class);
		IPropertyDescriptor propertyDescriptor = new TrailsPropertyDescriptor(
				Foo.class, Date.class);
