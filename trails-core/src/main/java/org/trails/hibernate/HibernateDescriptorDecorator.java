...
public class HibernateDescriptorDecorator implements DescriptorDecorator
{
															 ...
															 IClassDescriptor parentClassDescriptor)
	{
		...
		IPropertyDescriptor descriptorReference = new ObjectReferenceDescriptor(type, descriptor, hibernateType.getReturnedClass());
		...
		try
		{
			...
			descriptorReference.addExtension(OwningObjectReferenceDescriptor.class.getName(), owningObjectReferenceDescriptor);
