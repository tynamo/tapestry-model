...
import org.tynamo.io.ClassAdaptor;
...
public class SqueezerDataEncoderTest extends TestCase
{
	...
	{
		assertEquals("{1,Salejandro,Dorg.tynamo.record.SqueezerDataEncoder,T}",
	...
	{
		List nuevos = squeezerDataEncoder.decodePageChanges("{1,Salejandro,Dorg.tynamo.record.SqueezerDataEncoder,T}");
