...
public class FunctionalTest extends TestCase
{
    ...
    {
        return (HtmlForm)page.getAllForms().get(0);
    }
    ...
    {
        return clickButton((HtmlForm)page.getAllForms().get(0), buttonValue);
    }
    ...
    {
        HtmlSpan span = (HtmlSpan)new HtmlUnitXPath("//span[contains(preceding-sibling::label, '" + idField + "')]").selectSingleNode(savedCategoryPage);
        return span.asText();
    }
    ...
    protected HtmlTextInput getTextInputForField(HtmlPage newProductPage, String field) throws JaxenException
    {
        HtmlTextInput input = (HtmlTextInput)
            new HtmlUnitXPath("//span[contains(preceding-sibling::label, '" + field + "')]/input").selectSingleNode(newProductPage);
        return input;
    }
    ...
    protected HtmlTextArea getTextAreaByName(HtmlPage page, String name) throws JaxenException
    {
        HtmlTextArea textArea = (HtmlTextArea) 
            new HtmlUnitXPath("//span[contains(preceding-sibling::label, '" + name + "')]/textarea").selectSingleNode(page);
        return textArea;
    }
    ...
    {
        return (HtmlInput) 
            new HtmlUnitXPath("//span[contains(preceding-sibling::label, '" + name + "')]/input").selectSingleNode(page);
    }
