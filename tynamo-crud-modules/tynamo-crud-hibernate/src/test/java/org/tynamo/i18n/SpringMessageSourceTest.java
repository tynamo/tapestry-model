...
import org.tynamo.testhibernate.BarCollector;
...
public class SpringMessageSourceTest extends TestCase
{
	...
	public void testGetMessageWithParameter()
	{
		...
		value = messageSource.getMessage("org.tynamo.component.newlink", args, en);
		assertEquals(value, "New test");

		value = messageSource.getMessage("org.tynamo.component.newlink", args, pt);
		assertEquals(value, "Adicionar test");

		value = messageSource.getMessage("org.tynamo.component.newlink", args, ptBR);
		assertEquals(value, "Adicionar test");
	...
	public void testGetMessageWithDefaultValueAndParameter()
	{
		...
		value = messageSource.getMessageWithDefaultValue("org.tynamo.component.newlink", args, en, "DefaultMessage");
		assertEquals(value, "New test");

		value = messageSource.getMessageWithDefaultValue("org.tynamo.component.newlink", args, pt, "DefaultMessage");
		assertEquals(value, "Adicionar test");

		value = messageSource.getMessageWithDefaultValue("org.tynamo.component.newlink", args, ptBR, "DefaultMessage");
		assertEquals(value, "Adicionar test");
